...
func (al Alog) write(msg string, wg *sync.WaitGroup) {
	// If panic occurs after .Write, will just to end of function.
	// This will bypass the Unlock on ln 66, as this is defered, it is called when
	// the function gets to the end, a check for if a panic occured is made and if so
